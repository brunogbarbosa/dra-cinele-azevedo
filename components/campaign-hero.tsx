  ...
  return <section ref={motionRef} id="inicio" className="campaign" aria-labelledby="campaign-title">
    ...
    <div className="campaign-inner">
      <div className="campaign-copy">
        <p className="campaign-kicker">HARMONIZAÇÃO FACIAL · FULL FACE</p>
        <h1 id="campaign-title" aria-label={site.headline}>
          <span className="campaign-title-line"><span>BELEZA QUE</span></span>
          <span className="campaign-title-line"><span>PRESERVA</span></span>
          <span className="campaign-title-line"><span>QUEM VOCÊ É.</span></span>
        </h1>
        <p className="campaign-subtitle">Seus traços. Sua expressão. Sua essência.<br/>Um olhar completo para a sua beleza.</p>
      ...
      <div className="campaign-signature"><span aria-hidden="true"/><div><p>DRA. CINELE AZEVEDO</p><em>Harmonização facial.<br className="campaign-signature-break"/> Naturalidade em primeiro lugar.</em></div></div>
    </div>
  </section>;
}
